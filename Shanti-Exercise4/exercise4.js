/* 0. Declare two variables "apples" and "oranges". Assign a value of 20 to apples.
      Assign a value of 30 to oranges.
*/
let apples = 20;
let oranges = 30;
...
/* 6. Declare another variable "mangoes" and give it a value of 5. Multiply mangoes
      and apples, and check whether this result is greater than mangoes added to 
      oranges.
*/
const mangoes = 5;
console.log((mangoes * apples) > (mangoes + oranges)); // true

/* 7. Subtract mangoes from apples and check whether this result is less than oranges 
     divided by mangoes.
*/    
...
/* 9. Check whether the remainder of apples divided by mangoes and the remainder of
       oranges divided by mangoes are equal.
*/
